...
# Load the data file
file_path = 'proteomics histogram.xlsx'  # Replace with the correct path to your file
...
plt.tight_layout()
plt.savefig('prot_histogram_publication_grade.svg', dpi=300, bbox_inches='tight')
plt.show()
